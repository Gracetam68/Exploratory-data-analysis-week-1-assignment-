# Graphic-device-course-project-1-
This is the four plots for exploratory data analysis-week 1 project assignment.
I created four different plot scripts along with four plots files, so you can click each file to read toward different plots.

Note:
I did not download the dataset through URL because I can not find the original data through a link. 
Therefore, you have to download the file and unzip to save to the working directory.


Here is the assignment requirment below.
